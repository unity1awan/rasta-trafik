  ...
  return (
    <form onSubmit={handleSubmit} className={formClass}>
      <input
        ...
        autoCapitalize="off"
        spellCheck={false}
        className="flex-1 rounded-full border border-zinc-200 bg-white px-4 py-2.5 text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 disabled:opacity-50 transition-all"
      />
      <motion.button
        type="submit"
